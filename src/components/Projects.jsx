...
const Projects = () => {
  return (
    <div className="flex gap-5 mt-2 responsive">
      <Primary />
      <div className="w-min-[70%] h-[700px] mr-5 mt-10 flex flex-col px-10 pt-5 rounded-2xl bg-[#1E1E1F] shadow-[0_10px_30px_rgba(255,255,255,0.1)] fade-enter fade-enter-active page-enter responsive-secondary2">
        <div>
          ...
          <div>
            <div className="flex gap-1 mt-15 h-[80vh] flex-wrap responsive-project">
              <div className="bg-[#0b0b0c] text-white font-bold ml-5 rounded-[15px] p-3 cursor-pointer hover:transform hover:scale-105 duration-300 w-[300px] h-[200px] flex-wrap">
            ...
            <NavLink target="_blank" className="w-[120px] rounded-[20px] flex justify-center items-center bg-[#122365] text-[18px] px-2 res-button" to="https://github.com/Gopal-student21/Practice-projects">Visit Github</NavLink>
              </div>
            </div>
          </div>
        </div>
