...
const About = () => {
  return (
      ...
      <Primary/>
      <div className='w-[70%] h-[100vh] mr-5 gap-6 mt-10 flex flex-col px-10 pt-5 rounded-2xl bg-[#1E1E1F] shadow-[0_10px_30px_rgba(255,255,255,0.1)] fade-enter fade-enter-active page-enter'>
      ...
      <div className='text-gray-400 text-lg mt-5n flex  items-center  w-full border-2 border-purple-500 rounded-xl p-8'>
        <div className='flex gap-10 border-r-5 rounded-[5px]  border-purple-700 w-[70%]'>
        ...
        <div className=' w-[250px] flex flex-col justify-center items-center px-3  gap-4'>
